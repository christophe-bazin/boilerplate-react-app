      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-20 pb-16">
        <div className="text-center">
          ...
          <div className="flex justify-center mb-8">
            <div className="w-24 h-24 text-primary-600 dark:text-primary-400">
          ...
          {/* Main heading */}
          <h1 className="text-4xl sm:text-6xl font-bold text-secondary-900 dark:text-white mb-6">
            {config.app.name}
          </h1>
          ...
          {/* Description */}
          <p className="text-lg text-secondary-500 dark:text-secondary-400 mb-12 max-w-2xl mx-auto">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
            <Link
              to="/signup"
              className="px-8 py-4 text-lg font-medium text-white bg-primary-600 hover:bg-primary-700 rounded-lg transition-colors shadow-lg hover:shadow-xl"
            >
              {t('navigation.signUp')}
            </Link>
            <Link
              to="/signin"
              className="px-8 py-4 text-lg font-medium text-primary-600 dark:text-primary-400 bg-white dark:bg-secondary-800 hover:bg-secondary-50 dark:hover:bg-secondary-700 border border-primary-200 dark:border-secondary-600 rounded-lg transition-colors"
            >
              {t('navigation.signIn')}
            </Link>
          </div>
          ...
          <div className="mt-20 grid grid-cols-1 md:grid-cols-3 gap-8 max-w-5xl mx-auto">
            <div className="text-center p-6 bg-white dark:bg-secondary-800 rounded-xl shadow-lg">
              ...
              <p className="text-secondary-600 dark:text-secondary-300">
                Convertissez vos documents PDF en texte structuré et modifiable
              </p>
            </div>
            ...
            <div className="text-center p-6 bg-white dark:bg-secondary-800 rounded-xl shadow-lg">
              ...
              <p className="text-secondary-600 dark:text-secondary-300">
                Transformez vos fichiers audio en texte avec une précision élevée
              </p>
            </div>
            ...
            <div className="text-center p-6 bg-white dark:bg-secondary-800 rounded-xl shadow-lg">
              ...
              <p className="text-secondary-600 dark:text-secondary-300">
                Powered by intelligence artificielle pour des résultats optimaux
              </p>
            </div>
          </div>
        </div>
